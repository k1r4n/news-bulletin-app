...
class Music extends Component {
    ...
    fetchChannelList() {
      axios.get('http://localhost:9200/news-bulletin/top-channels/_search?pretty=true&size=100&q=category:music')
          .then(response => {
                ...
                <div className="container">
                    <div className="panel panel-primary" style={{ marginTop: '20px' }}>
                        <div className="panel-heading">
                            <h1 style={{ marginLeft: '20px' }}><i className="fa fa-music" aria-hidden="true"></i>  Music</h1>
                        </div>
                        <div className="panel-body">
                            {
                                data && data.map((data, index) => (
                                        <Link to ={`/music/${data._id}`} key={data._id}>
